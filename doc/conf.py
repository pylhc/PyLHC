...
import os
import sys
sys.path.insert(0, os.path.abspath('../pylhc/'))
...
latex_documents = [
    (master_doc, 'pylhc.tex', u'pyLHC Documentation',
     u'OMC-TEAM', 'manual'),
]
...
man_pages = [
    (master_doc, 'pylhc', u'pyLHC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pylhc', u'pyLHC Documentation',
     author, 'OMC-TEAM', 'One line description of project.',
     'Miscellaneous'),
]
...
autodoc_mock_imports = ['PyQt5', 'PyQt5.QtGui', 'PyQt5.QtCore', 'PyQt5.QtWidgets',
                        ...
                        "pjlsa", 'pjlsa.LSAClient',  # travis does not have JARs
                        ]
